...
class DetectionTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path: str, mode: str = "train", batch: int | None = None):
        ...
        use_rect = mode == "val" and self.qat_model is None
        return build_yolo_dataset(self.args, img_path, batch, self.data, mode=mode, rect=use_rect, stride=gs)
    ...
    def get_validator(self):
        ...
        self.loss_names = ("box_loss", "cls_loss", "dfl_loss", "kd_loss") if self.args.qat_kd else (
            "box_loss",
            "cls_loss",
            "dfl_loss",
        )
