...
class BaseModel(torch.nn.Module):
    ...
    def loss(self, batch, preds=None, teacher_preds=None):
        """Compute loss.

        Args:
            batch (dict): Batch to compute loss on.
            preds (torch.Tensor | list[torch.Tensor], optional): Predictions.
            teacher_preds (torch.Tensor | list[torch.Tensor], optional): Teacher predictions for KD-enabled training.
        """
        ...
        return self.criterion(preds, batch, teacher_preds=teacher_preds)
