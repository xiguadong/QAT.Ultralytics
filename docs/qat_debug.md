...
- Python: `/home/heqi/miniforge3/envs/yolo26/bin/python`
- Python 版本: `3.10.19`
...
```bash
/home/heqi/miniforge3/envs/yolo26/bin/python -m compileall ultralytics
```
...
```bash
/home/heqi/miniforge3/envs/yolo26/bin/python - <<'PY'
...
- 已用 `/home/heqi/miniforge3/envs/yolo26/bin/python` 直接调用测试函数完成等价验证
